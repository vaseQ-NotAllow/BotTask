...
public class EntryPoint {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        IGenerator generator = new SQLTaskGenerator();
        ...
        ConsoleMessager consoleMessager = new ConsoleMessager();
        //tgBot.subscribe(bot);
        consoleMessager.subscribe(bot);
        //bot.subscribe(tgBot);
        bot.subscribe(consoleMessager);
        consoleMessager.Run();
    }
}
